...
export default function BottomNav() {
  ...
  return (
    <nav className="sticky bottom-0 left-0 right-0 bg-white border-t border-ink-200 px-2 pt-2 pb-3 z-40">
      <div className="flex items-end justify-around">
        {tabs.map((t) => {
          const Icon = t.icon;
          const active = path === t.href || (t.href !== '/home' && t.href !== '/vendedor' && path.startsWith(t.href));
          if (t.accent) {
            return (
